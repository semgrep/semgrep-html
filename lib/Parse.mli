...
(**
    Functions for parsing html programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a html program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.fragment, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a html program from a file into a typed OCaml CST.
